...
return [
    ...
    */
    ...
    'default_classes' => [
        'row' => [
            'even' => 'divide-x divide-gray-100 text-sm text-gray-600 bg-gray-100',
            'odd' => 'divide-x divide-gray-100 text-sm text-gray-600 bg-gray-50',
            'selected' => 'divide-x divide-gray-100 text-sm text-gray-600 bg-yellow-100',
        ],
        'cell' => 'whitespace-no-wrap text-sm text-gray-600 px-6 py-2',
    ],
];
