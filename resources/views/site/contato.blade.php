<x-site-layout>
    ...
    <div class="bg-white rounded-md text-azul-m p-3 my-3 md:my-5 lg:hidden">
        ...
        <div>
            <span class="inline-flex items-baseline">
                <img src="{{ asset('images/icons/envelope.svg') }}" alt="" class="self-center w-4 h-4 sm:w-6 sm:h-6 mr-0.5 sm:mr-1 icon-envelope" />
                <span class="text-xs sm:text-base">lorenipsulon@lorenloripsulone.com.br</span>
            </span>
        </div>
        ...
        <div>
            <span class="inline-flex items-baseline sm:mt-2">
                ...
                <span class="text-xs sm:text-base">11 0000 0000</span>
            </span>
        </div>
    </div>
    ...
    <div class="hidden lg:block w-[866px] h-[534px] text-azul-m mx-auto" style="background-image: url({{ asset('images/contato/bg_contato_full.png') }})">
        <div class="pt-52 pl-32">
            ...
            <div>
                <span class="inline-flex items-baseline">
                    <img src="{{ asset('images/icons/envelope.svg') }}" alt="" class="self-center w-8 h-8 mr-2 icon-envelope" />
                    <span class="text-lg">lorenipsulon@lorenloripsulone.com.br</span>
                </span>
            </div>
            ...
            <div>
                <span class="inline-flex items-baseline mt-4">
                    ...
                    <span class="text-lg">11 0000 0000</span>
                </span>
            </div>
        </div>
    ...
    <div class="my-4">
        <span class="inline-flex items-center">
            ...
            <a href="#" target="_blank"><img src="{{ asset('images/contato/insta.png') }}" alt="Instagram" class="self-center w-8 h-8 mx-2" /></a>
            <a href="#" target="_blank"><img src="{{ asset('images/contato/face.png') }}" alt="Facebook" class="self-center w-8 h-8 mx-2" /></a>
            <a href="#" target="_blank"><img src="{{ asset('images/contato/yt.png') }}" alt="You Tube" class="self-center w-8 h-8 mx-2" /></a>
            <a href="#" target="_blank"><img src="{{ asset('images/contato/tw.png') }}" alt="Twitter" class="self-center w-8 h-8 mx-2" /></a>
        </span>
    </div>
</x-site-layout>